...
export function drawScene(fullRes =  false, time = 0){
  ...
  const debugSphere = sphere(translation(0, 0, -2).mul(scaling(5, 5, 0.001)), material({ color: createColor(0.9, 0.7, 0.7) }));
  world.addObject(debugSphere);
  world.addObject(sphere(translation(0, 0, 0).mul(scaling(5, 0.001, 5)), material({ color: createColor(0.5, 0.5, 0.8) })));
